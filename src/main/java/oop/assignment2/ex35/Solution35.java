...
public class Solution35 {
    ...
    public static void main(String[] args) {
        winner list = new winner();
        List<String> contestant = Collections.singletonList(list.whoWins());

        String output = generateOutput(contestant);

        System.out.println(output);
    }

    public static String generateOutput(List<String> contestant){
        return "And the winner is... " + contestant + ".";
    }
}
